 ...
 "cells": [
  ...
  },
  {
   ...
   "source": [
    ...
    "    name=\"intro\", \n",
    "    description=\"intro\",\n",
    "    pipeline_root=\"gs://dev-dp-vertex-analytics-ai/demo\"\n",
    ")\n",
    "\n",
    "def main_pipeline(\n",
    "    project: str,\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "bucket_name = \"dev-dp-vertex-analytics-ai\"\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "aiplatform.init(project=\"int-advanced-analytics-01\", location=\"us-central1\")"
   ]
  },
  {
   "cell_type": "code",
   ...
   "outputs": [
    {
     ...
     "text": [
      ...
      "PipelineJob created. Resource name: projects/624205664083/locations/us-central1/pipelineJobs/intro-20240601161508\n",
      "To use this PipelineJob in another session:\n",
      "pipeline_job = aiplatform.PipelineJob.get('projects/624205664083/locations/us-central1/pipelineJobs/intro-20240601161508')\n",
      "View Pipeline Job:\n",
      "https://console.cloud.google.com/vertex-ai/locations/us-central1/pipelines/runs/intro-20240601161508?project=624205664083\n"
     ]
    }
   ],
   "source": [
    ...
    "    template_path=\"gs://dev-dp-vertex-analytics-ai/demo/pipeline_prediction.json\",\n",
    "    #job_id=\"mlops72\",\n",
    "    enable_caching=False,\n",
    "    project=\"int-advanced-analytics-01\",\n",
    "    location=\"us-central1\",\n",
    "    parameter_values={\"project\": \"int-advanced-analytics-01\", \n",
    "                      \"source_x_train_table\": \"int-advanced-analytics-01.expl_research_laybarm.xtrain\",\n",
    "                      \"features_table\": \"int-advanced-analytics-01.expl_research_laybarm.selected_features\",\n",
    "                      \"table_id\": \"int-advanced-analytics-01.expl_research_laybarm.predictions\",\n",
    "                      \"path_model\": \"gs://dev-dp-vertex-analytics-ai/demo/data/model/model.joblib\"\n",
    "                     },\n",
    "    failure_policy = 'slow'\n",
    ...
    "job.submit(service_account=\"dev-dp-ml-vertex@int-advanced-analytics-01.iam.gserviceaccount.com\")"
   ]
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "60ad0688-9d56-4e8b-905b-7df32fa7e246",
   "metadata": {},
   "outputs": [],
   "source": []
  }
